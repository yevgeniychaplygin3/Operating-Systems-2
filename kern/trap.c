...
page_fault_handler(struct Trapframe *tf)
{
	...
	// LAB 3: Your code here.
    //check current privilage level of the trap frame tf because tf stores
    //the context of when the fault or exception happens.
    if ((tf->tf_cs&0x3) == 0){
        panic("Kernel triple fault in page_fault_handler");
    }
